...
finshi <- tribble(~Variable,~Legend,~Color,
                  ...
                  'Fin_Ene_Tra_Shi_Gas','Gas','moccasin',
...
emisec <- tribble(~Variable,~Legend,~Color,
                  ...
                  'Emi_CO2_Ind_Pro','Industrial process','grey',
                  'Emi_CO2_Oth','DACCS','lightsteelblue')
...
carcap <- tribble(~Variable,~Legend,~Color,
                  ...
                  'Car_Cap_Dir_Air_Cap','DAC','lightsteelblue')

# Carbon sequestration
carseq <- tribble(~Variable,~Legend,~Color,
                  "Car_Seq_Dir_Air_Cap",'DACCS','lightsteelblue',
