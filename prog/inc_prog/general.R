...
fplot_fbar(var=prmene, name_file='PES2', ylabel='Primary energy supply (EJ/yr)', cpt='Primary Energy', w=200, h=120)
...
fplot_fbar(var=secele, name_file='ELE2', ylabel='Electricity generation (EJ/yr)', cpt='Power generation', w=200, h=120)
...
fplot_fbar(var=sechyd, name_file='HYD2',ylabel='Hydrogen generation (EJ/yr)',cpt='Hydrogen generation', w=200, h=120)
...
fplot_fbar(var=finene, name_file='FEC_src2', ylabel='Final energy consumption (EJ/yr)', cpt='Final Energy', w=200, h=120)
...
fplot_fbar(var=finind, name_file='FEC_ind2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Ind', w=200, h=120)
...
fplot_fbar(var=finbui, name_file='FEC_bld2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Buildings', w=200, h=120)
...
fplot_fbar(var=finres, name_file='FEC_res2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Res', w=200, h=120)
...
fplot_fbar(var=fincom, name_file='FEC_com2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Com', w=200, h=120)
...
fplot_fbar(var=fintra, name_file='FEC_trp2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Tra', w=200, h=120)
...
fplot_fbar(var=finpss, name_file='FEC_pss2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Passenger', w=200, h=120)
...
fplot_fbar(var=finfre, name_file='FEC_frg2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Freight', w=200, h=120)
...
fplot_fbar(var=finroa, name_file='FEC_roa2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Road', w=200, h=120)
...
fplot_fbar(var=finavi, name_file='FEC_avi2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Aviation', w=200, h=120)
...
fplot_fbar(var=finshi, name_file='FEC_shi2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Shipping', w=200, h=120)
...
fplot_fbar(var=finrai, name_file='FEC_rai2', ylabel='Final energy consumption (EJ/yr)', cpt='Fin_Ene_Rail', w=200, h=120)
...
fplot_fbar(var=carcap, name_file='Car_Cap2', ylabel=expression(paste('Carbon capture (Mt-',CO[2],'/yr)')), cpt='Car_Cap', w=200, h=120)
...
fplot_fbar(var=carseq, name_file='Car_Seq2', ylabel=expression(paste('Carbon sequestration/utilization (Mt-',CO[2],'/yr)')), cpt='Car_Seq', w=200, h=120)
