...
fplot_path(var='Pol_Cos_per_GDP', name_file='Cost_Policy_cost_per_GDP', ylabel='Policy cost per GDP (%)', ylab=scales::percent, cpt='Energy system cost')
